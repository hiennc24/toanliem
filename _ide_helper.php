 ...
 * Generated for Laravel 7.14.1 on 2020-06-09 08:52:24.
 *
...
namespace Botble\Base\Facades { 
    ...
    class EmailHandlerFacade {
         ...
         * @static 
         */ 
        public static function sendUsingTemplate($template, $email = null, $args = [], $debug = false)
        {
                        /** @var \Botble\Base\Supports\EmailHandler $instance */
                        return $instance->sendUsingTemplate($template, $email, $args, $debug);
        }
...
namespace Botble\Slug\Facades { 
    ...
    class SlugHelperFacade {
         ...
         * 
         *
         * @param \Botble\Slug\BaseModel $model
         * @return \Botble\Slug\SlugHelper 
         * @static 
         */ 
...
namespace Botble\Media\Facades { 
    ...
    class RvMediaFacade {
         ...
         * @static 
         */ 
        public static function handleUpload($fileUpload, $folderId = 0, $folderSlug = null)
        {
                        /** @var \Botble\Media\RvMedia $instance */
                        return $instance->handleUpload($fileUpload, $folderId, $folderSlug);
        }
         ...
         *
         * @param \Illuminate\Http\Request $request
         * @return \Illuminate\Contracts\Foundation\Application|\Illuminate\Contracts\Routing\ResponseFactory|\Botble\Media\JsonResponse|\Illuminate\Http\Response 
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function getObjectImage($image, $size = null, $relativePath = false)
        {
                        /** @var \Botble\Media\RvMedia $instance */
                        return $instance->getObjectImage($image, $size, $relativePath);
        }
